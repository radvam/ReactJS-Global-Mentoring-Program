...
import { FormMovie } from "../../components/common/Form/form-movie/FormMovie";
...
export const FormAddConnected = connect(null, {
  onSubmit: postMovieRequest,
})(FormMovie);

export const FormEditConnected = connect(null, {
  onSubmit: putMovieRequest,
})(FormMovie);
